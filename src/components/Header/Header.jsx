...
const Header = () => {
  return (
    <Container sx={{maxWidth: '1366px !important', pl: 2, pr: 2, mt: 2, maxHeight: '114px'}} disableGutters={true}>
      <Stack direction='row' spacing={2} maxHeight='114px'>
        <Box zIndex={1}><img src='../../logo.svg' alt='team_logo' width='178px' style={{ filter: 'drop-shadow(5px 5px 5px rgb(0 0 0 / 0.6))', cursor: 'pointer'}} /></Box>
